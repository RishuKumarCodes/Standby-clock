...
const BatteryIndicator = ({ batteryLevel = 100, charging = false, color }) => {
  // Each cell represents 20%
  ...
  // Animated value for blinking the last filled cell when charging
  ...
  useEffect(() => {
    if (charging && filledCells > 0) {
      ...
      // Reset blinkOpacity to static value
      blinkOpacity.setValue(1);
    }
  }, [charging, blinkOpacity, filledCells]);
